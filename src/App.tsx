    ...
    <BrowserRouter>
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route path="/full-application/executive-analytics" element={<FullApplication />} />
          <Route path="/full-application/work-orders/recently-added" element={<FullApplication />} />
          <Route path="/full-application/work-orders/pending" element={<FullApplication />} />
          <Route path="/full-application/work-orders/scheduled" element={<FullApplication />} />
          <Route path="/full-application/work-orders/in-progress" element={<FullApplication />} />
          <Route path="/full-application/work-orders/waiting-for-parts" element={<FullApplication />} />
          ...
          <Route path="/full-application/calendar/ai-schedule" element={<FullApplication />} />
          ...
          <Route path="/full-application/editable-forms" element={<FullApplication />} />
